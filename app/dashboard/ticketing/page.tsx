...
export default function TicketingDashboard() {
  ...
  const handleExportToExcel = () => {
    ...
    const exportData = filtered.map((request) => ({
      ...
      Site: request.site,
      POH: request.poh,
      "Berangkat Dari": request.berangkatDari,
      Tujuan: request.tujuan,
      "Tanggal Keberangkatan": formatDate(request.tanggalKeberangkatan),
      "Tanggal Mulai Cuti": formatDate(request.tanggalMulai),
      "Tanggal Berakhir Cuti": formatDate(request.tanggalSelesai),
      "Jenis Izin": request.jenisPengajuanCuti,
